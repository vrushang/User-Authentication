...
public class ApplicationException extends Exception {
    ...
    public ApplicationException(final com.registerWithJWT.registerWithJWT.exception.ErrorCode errorCode, final Object... parameters) {
        super();
        this.errorCode = errorCode;
        this.parameters = parameters;
    }

    public ApplicationException(final com.registerWithJWT.registerWithJWT.exception.ErrorCode errorCode, final Throwable cause, final Object... parameters) {
        super();
        this.errorCode = errorCode;
        this.cause = cause;
        this.parameters = parameters;
    ...
    public com.registerWithJWT.registerWithJWT.exception.ErrorCode getErrorCode() {
        return errorCode;
    }
